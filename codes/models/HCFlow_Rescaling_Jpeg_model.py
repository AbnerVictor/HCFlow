...
class HCFLowRescalingJpegModel(BaseModel):
    ...
    def pad_JPEG(self, x):
        ...
        save_img_path = osp.join(self.dataset_dir, self.img_name + '_jpeg.jpg')
        x_jpg = self.DiffJPEG(x, save_jpg_path=save_img_path)
        x_jpg = x_jpg[:, :, :h, :w]
        return x_jpg
    ...
    def feed_data(self, data, need_GT=True):
        ...
        # for torchjpeg image saving
        # self.img_path = data['GT_path'][0]
